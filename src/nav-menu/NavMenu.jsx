...
class NavMenu extends React.Component {
  constructor(props) {
    super(props);
    this.state = { visibility: "none", subcategories: [], navItem: {}, categories: [] };
  ...
  render() {
    ...
    const appliances = [
      getCategoryItem('Техника для кухни', [ {imgSrc: 'https://c.dns-shop.ru/thumb/st4/fit/220/150/0a09f6b0a3ba8b952f184999aae62ec2/2252f632365bda05431a61498a99b847b303e5ea3ade88a799fb9a6a7795e558.png', header: 'Холодильное оборудование,Fridge', brands: ['Beko', 'Samsung']} ])
    ];
    const tvs = [
      getCategoryItem('Телевизоры', [ {imgSrc: 'https://c.dns-shop.ru/thumb/st4/fit/320/250/810c9a092de66e75ef788b94005f1faa/35027b8070857159ea00154bba5513557a8e2b0d52723b160984494f2150e5b2.jpg', header: 'Телевизоры,TV', brands: ['LG', 'Samsung', 'Phillips']} ])
    ];
    const phones = [
      getCategoryItem('Смартфоны', [ {imgSrc: 'https://c.dns-shop.ru/thumb/st1/fit/220/150/341d0847688b64d0ef79f391d8dc1e0b/91b384bd6d56f835dfb5c7974c430ff6be88200a29145acd983e6e7ac2d2c220.jpg', header: 'Смартфоны,Smartphone', brands: ['Samsung', 'Apple', 'Xiaomi']}])
    ];
    const house = [
      getCategoryItem('Мебель', [ {imgSrc: 'https://c.dns-shop.ru/thumb/st1/fit/220/150/2d695e9726c7f92ef43565be5d73b3e3/d55dbfc898132a67c120e06da88b49f3c5d1c3bc0f00d807c4921343778cc9b1.jpg', header: 'Мебель,Furniture', brands: ['Belezza', 'Mona Liza']} ])
    ];
