...
function ProductRow(props){
  ...
  function onClick(e){
    ...
    return (
      <a className={className} href={"/products/" + props.product.id} onClick={(e) => onClick(e)} title={props.product.name} onDragStart={(e) => e.preventDefault()}>
        ...
        <div className="product-row__top">
          ...
          <div className="right-block" title="Количество просмотров">
            <svg className="right-block__icon" version="1.1" xmlns="http://www.w3.org/2000/svg"
...
<g>
  ...
  <g>
		<path d="M221.02,246.021c-13.785,0-25-11.215-25-25s11.215-25,25-25c13.786,0,25,11.215,25,25S234.806,246.021,221.02,246.021z"/>
            ...
            <p style={{height: "100%", verticalAlign: "middle", display: "inline-block"}}>{props.product.viewsCount}</p>
          </div>
      </a>
    );
}
